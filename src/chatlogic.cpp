...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // local stack chatbot
    ChatBot chatterbot("../images/chatbot.png");
    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    chatterbot.SetChatLogicHandle(this);
    // add chatbot to graph root node
    chatterbot.SetRootNode(rootNode);
    // force move semantics using std::move
    rootNode->MoveChatbotHere(std::move(chatterbot));
